...
// Key is read from BOQA_API_KEY env var. If not set, protection is disabled
// (for backward compat in dev), but a warning is logged on boot.

const API_KEY = process.env.BOQA_API_KEY || null;
