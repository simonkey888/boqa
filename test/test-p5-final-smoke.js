/**
 * BOQA test-p5-final-smoke.js — Phase 5 Finalization Smoke Test
 *
 * Validates the complete P5 stack end-to-end:
 *   1. Health endpoints (/api/health, /api/replay/health)
 *   2. Record a simple browser session
 *   3. Replay the session deterministically
 *   4. Verify degraded mode behavior
 *   5. Verify manifests and redaction
 *   6. Runtime blocker verification (res.fromCache)
 *   7. Route namespace verification
 *
 * This test starts the BOQA server and makes HTTP requests.
 * Run with: node test-p5-final-smoke.js
 */
...
const HOST = process.env.BOQA_HOST || '127.0.0.1';
